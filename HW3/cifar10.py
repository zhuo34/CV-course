...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_epochs', metavar='MIN_EPOCHS', type=int, default=200, help='min epochs')
    parser.add_argument('--max_epochs', metavar='MAX_EPOCHS', type=int, default=300, help='max epochs')
    ...
    parser.add_argument('--weight_decay', metavar='weight_decay', type=float, default=5e-4, help='weight decay')
    ...
    if args.mode == 'train':
        ...
        model = myresnet18.load_from_checkpoint(cp_path, args=args)
        trainer = pl.Trainer(
            gpus=args.gpus,
            logger=False
        )
